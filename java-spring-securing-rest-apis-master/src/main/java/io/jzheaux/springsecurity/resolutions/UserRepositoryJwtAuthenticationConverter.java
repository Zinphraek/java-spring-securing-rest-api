...
public class UserRepositoryJwtAuthenticationConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    public AbstractAuthenticationToken convert(Jwt jwt) {
        ...
        authorities.removeAll(userAuthorities);
        OAuth2AuthenticatedPrincipal principal = new UserOAuth2AuthenticatedPrincipal(
                user, jwt.getClaims(), authorities
        );
    ...
    private static class UserOAuth2AuthenticatedPrincipal extends User implements OAuth2AuthenticatedPrincipal {
        ...
        private UserOAuth2AuthenticatedPrincipal(User user, Map<String, Object> attributes,
